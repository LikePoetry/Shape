...
namespace Shapes
{
    namespace WindowsKeyCodes
    {
        ...
        inline Shapes::InputCode::Key WindowsKeyToShapes(uint32_t key)
        {
            static std::map<uint32_t, Shapes::InputCode::Key> keyMap = {
                { KEYBOARD_A, Shapes::InputCode::Key::A },
                { KEYBOARD_B, Shapes::InputCode::Key::B },
                { KEYBOARD_C, Shapes::InputCode::Key::C },
                { KEYBOARD_D, Shapes::InputCode::Key::D },
                { KEYBOARD_E, Shapes::InputCode::Key::E },
                { KEYBOARD_F, Shapes::InputCode::Key::F },
                { KEYBOARD_G, Shapes::InputCode::Key::G },
                { KEYBOARD_H, Shapes::InputCode::Key::H },
                { KEYBOARD_I, Shapes::InputCode::Key::I },
                { KEYBOARD_J, Shapes::InputCode::Key::J },
                { KEYBOARD_K, Shapes::InputCode::Key::K },
                { KEYBOARD_L, Shapes::InputCode::Key::L },
                { KEYBOARD_M, Shapes::InputCode::Key::M },
                { KEYBOARD_N, Shapes::InputCode::Key::N },
                { KEYBOARD_O, Shapes::InputCode::Key::O },
                { KEYBOARD_P, Shapes::InputCode::Key::P },
                { KEYBOARD_Q, Shapes::InputCode::Key::Q },
                { KEYBOARD_R, Shapes::InputCode::Key::R },
                { KEYBOARD_S, Shapes::InputCode::Key::S },
                { KEYBOARD_T, Shapes::InputCode::Key::T },
                { KEYBOARD_U, Shapes::InputCode::Key::U },
                { KEYBOARD_V, Shapes::InputCode::Key::V },
                { KEYBOARD_W, Shapes::InputCode::Key::W },
                { KEYBOARD_X, Shapes::InputCode::Key::X },
                { KEYBOARD_Y, Shapes::InputCode::Key::Y },
                { KEYBOARD_Z, Shapes::InputCode::Key::Z },

                { KEYBOARD_0, Shapes::InputCode::Key::D0 },
                { KEYBOARD_1, Shapes::InputCode::Key::D1 },
                { KEYBOARD_2, Shapes::InputCode::Key::D2 },
                { KEYBOARD_3, Shapes::InputCode::Key::D3 },
                { KEYBOARD_4, Shapes::InputCode::Key::D4 },
                { KEYBOARD_5, Shapes::InputCode::Key::D5 },
                { KEYBOARD_6, Shapes::InputCode::Key::D6 },
                { KEYBOARD_7, Shapes::InputCode::Key::D7 },
                { KEYBOARD_8, Shapes::InputCode::Key::D8 },
                { KEYBOARD_9, Shapes::InputCode::Key::D9 },

                { KEYBOARD_SUBTRACT, Shapes::InputCode::Key::Minus },
                { KEYBOARD_DELETE, Shapes::InputCode::Key::Delete },
                { KEYBOARD_SPACE, Shapes::InputCode::Key::Space },
                { KEYBOARD_LEFT, Shapes::InputCode::Key::Left },
                { KEYBOARD_RIGHT, Shapes::InputCode::Key::Right },
                { KEYBOARD_UP, Shapes::InputCode::Key::Up },
                { KEYBOARD_DOWN, Shapes::InputCode::Key::Down },
                { KEYBOARD_LSHIFT, Shapes::InputCode::Key::LeftShift },
                { KEYBOARD_RSHIFT, Shapes::InputCode::Key::RightShift },
                { KEYBOARD_LCONTROL, Shapes::InputCode::Key::LeftControl },
                { KEYBOARD_RCONTROL, Shapes::InputCode::Key::RightControl },
                { KEYBOARD_LWIN, Shapes::InputCode::Key::LeftSuper },
                { KEYBOARD_RWIN, Shapes::InputCode::Key::RightSuper },
                { KEYBOARD_LMENU, Shapes::InputCode::Key::Menu },
                { KEYBOARD_ESCAPE, Shapes::InputCode::Key::Escape },
                { KEYBOARD_ADD, Shapes::InputCode::Key::Equal },
                { KEYBOARD_BACK, Shapes::InputCode::Key::Backspace },
                { KEYBOARD_RETURN, Shapes::InputCode::Key::Enter },
                { KEYBOARD_COMMA, Shapes::InputCode::Key::Comma }
            };
