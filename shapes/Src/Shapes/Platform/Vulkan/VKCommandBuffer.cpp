...
namespace Shapes
{
	namespace Graphics
	{
		...
		{
			SHAPES_PROFILE_FUNCTION();
			SHAPES_ASSERT(m_Primary, "BeginRecording() called from a secondary command buffer!");
		...
		{
			SHAPES_PROFILE_FUNCTION();
			SHAPES_ASSERT(!m_Primary, "BeginRecordingSecondary() called from a primary command buffer!");
			m_State = CommandBufferState::Recording;
		...
		{
			SHAPES_PROFILE_FUNCTION();
			SHAPES_ASSERT(m_State == CommandBufferState::Recording, "CommandBuffer ended before started recording");
		...
		{
			SHAPES_PROFILE_FUNCTION();
			SHAPES_ASSERT(m_Primary, "Used Execute on secondary command buffer!");
			SHAPES_ASSERT(m_State == CommandBufferState::Ended, "CommandBuffer executed before ended recording");
			...
			{
				SHAPES_PROFILE_SCOPE("vkQueueSubmit");
		...
		{
			SHAPES_PROFILE_FUNCTION();
			SHAPES_ASSERT(!m_Primary, "Used ExecuteSecondary on primary command buffer!");
			m_State = CommandBufferState::Submitted;
		...
		{
			SHAPES_PROFILE_FUNCTION();
			SHAPES_ASSERT(m_State == CommandBufferState::Submitted, "");
