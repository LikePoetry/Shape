...
#if defined(SHAPES_PLATFORM_MACOS) || defined(SHAPES_PLATFORM_WINDOWS) || defined(SHAPES_PLATFORM_LINUX)
#define USING_GLFW
#endif
...
namespace Shapes
{
    ...
    void ImGuiManager::OnInit()
    {
        ...
        SHAPES_LOG_INFO("ImGui Version : {0}", IMGUI_VERSION);
#ifdef IMGUI_USER_CONFIG
        SHAPES_LOG_INFO("ImConfig File : {0}", std::string(IMGUI_USER_CONFIG));
#endif
    ...
    int ShapesMouseButtonToImGui(Shapes::InputCode::MouseKey key)
    {
        switch(key)
        {
        case Shapes::InputCode::MouseKey::ButtonLeft:
            return 0;
        case Shapes::InputCode::MouseKey::ButtonRight:
            return 1;
        case Shapes::InputCode::MouseKey::ButtonMiddle:
            return 2;
        default:
            return 4;
        }
    ...
    {
        ImGuiIO& io                                               = ImGui::GetIO();
        io.MouseDown[ShapesMouseButtonToImGui(e.GetMouseButton())] = true;
    ...
    {
        ImGuiIO& io                                               = ImGui::GetIO();
        io.MouseDown[ShapesMouseButtonToImGui(e.GetMouseButton())] = false;
    ...
    bool ImGuiManager::OnKeyPressedEvent(KeyPressedEvent& e)
    {
        ...
        io.KeyCtrl  = io.KeysDown[(int)Shapes::InputCode::Key::LeftControl] || io.KeysDown[(int)Shapes::InputCode::Key::RightControl];
        io.KeyShift = io.KeysDown[(int)Shapes::InputCode::Key::LeftShift] || io.KeysDown[(int)Shapes::InputCode::Key::RightShift];
        io.KeyAlt   = io.KeysDown[(int)Shapes::InputCode::Key::LeftAlt] || io.KeysDown[(int)Shapes::InputCode::Key::RightAlt];

#ifdef _WIN32
        io.KeySuper = false;
#else
        io.KeySuper = io.KeysDown[(int)Shapes::InputCode::Key::LeftSuper] || io.KeysDown[(int)Shapes::InputCode::Key::RightSuper];
#endif
    ...
    void ImGuiManager::SetImGuiKeyCodes()
    {
        ...
        io.KeyMap[ImGuiKey_Tab]        = (int)Shapes::InputCode::Key::Tab;
        io.KeyMap[ImGuiKey_LeftArrow]  = (int)Shapes::InputCode::Key::Left;
        io.KeyMap[ImGuiKey_RightArrow] = (int)Shapes::InputCode::Key::Right;
        io.KeyMap[ImGuiKey_UpArrow]    = (int)Shapes::InputCode::Key::Up;
        io.KeyMap[ImGuiKey_DownArrow]  = (int)Shapes::InputCode::Key::Down;
        io.KeyMap[ImGuiKey_PageUp]     = (int)Shapes::InputCode::Key::PageUp;
        io.KeyMap[ImGuiKey_PageDown]   = (int)Shapes::InputCode::Key::PageDown;
        io.KeyMap[ImGuiKey_Home]       = (int)Shapes::InputCode::Key::Home;
        io.KeyMap[ImGuiKey_End]        = (int)Shapes::InputCode::Key::End;
        io.KeyMap[ImGuiKey_Insert]     = (int)Shapes::InputCode::Key::Insert;
        io.KeyMap[ImGuiKey_Delete]     = (int)Shapes::InputCode::Key::Delete;
        io.KeyMap[ImGuiKey_Backspace]  = (int)Shapes::InputCode::Key::Backspace;
        io.KeyMap[ImGuiKey_Space]      = (int)Shapes::InputCode::Key::Space;
        io.KeyMap[ImGuiKey_Enter]      = (int)Shapes::InputCode::Key::Enter;
        io.KeyMap[ImGuiKey_Escape]     = (int)Shapes::InputCode::Key::Escape;
        io.KeyMap[ImGuiKey_A]          = (int)Shapes::InputCode::Key::A;
        io.KeyMap[ImGuiKey_C]          = (int)Shapes::InputCode::Key::C;
        io.KeyMap[ImGuiKey_V]          = (int)Shapes::InputCode::Key::V;
        io.KeyMap[ImGuiKey_X]          = (int)Shapes::InputCode::Key::X;
        io.KeyMap[ImGuiKey_Y]          = (int)Shapes::InputCode::Key::Y;
        io.KeyMap[ImGuiKey_Z]          = (int)Shapes::InputCode::Key::Z;
