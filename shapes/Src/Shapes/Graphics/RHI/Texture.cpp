...
namespace Shapes
{
    namespace Graphics
    {
        ...
        RHIFormat Texture::BitsToFormat(uint32_t bits)
        {
            ...
            default:
                SHAPES_ASSERT(false, "[Texture] Unsupported image bit-depth! ({0})", bits);
                return RHIFormat::R8G8B8A8_Unorm;
            }
        }
        ...
        {
            SHAPES_ASSERT(CreateFunc, "No Texture2D Create Function");
        ...
        {
            SHAPES_ASSERT(CreateFromSourceFunc, "No Texture2D Create Function");
        ...
        {
            SHAPES_ASSERT(CreateFromFileFunc, "No Texture2D Create Function");
        ...
        {
            SHAPES_ASSERT(CreateFunc, "No TextureCube Create Function");
        ...
        {
            SHAPES_ASSERT(CreateFromFileFunc, "No TextureCube Create Function");
        ...
        {
            SHAPES_ASSERT(CreateFromFilesFunc, "No TextureCube Create Function");
        ...
        {
            SHAPES_ASSERT(CreateFromVCrossFunc, "No TextureCube Create Function");
        ...
        {
            SHAPES_ASSERT(CreateFunc, "No TextureDepth Create Function");
        ...
        {
            SHAPES_ASSERT(CreateFunc, "No TextureDepthArray Create Function");
