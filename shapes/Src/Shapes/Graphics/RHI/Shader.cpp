...
namespace Shapes
{
    namespace Graphics
    {
        ...
        {
            SHAPES_ASSERT(CreateFunc, "No Shader Create Function");
        ...
        {
            SHAPES_ASSERT(CreateFuncFromEmbedded, "No Shader Create Function");
        ...
        {
            SHAPES_ASSERT(CreateCompFuncFromEmbedded, "No Shader Create Function");
            return CreateCompFuncFromEmbedded(compData, compDataSize);
        }

        ShaderDataType Shader::SPIRVTypeToShapesDataType(const spirv_cross::SPIRType type)
        {
            ...
            SHAPES_LOG_WARN("Unknown spirv type!");
