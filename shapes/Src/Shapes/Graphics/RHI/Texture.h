...
namespace Shapes
{
    namespace Graphics
    {
        class SHAPES_EXPORT Texture : public Asset
        {
        public:
            virtual ~Texture()
            {
        ...
        class SHAPES_EXPORT Texture2D : public Texture
        {
        public:
        ...
        class SHAPES_EXPORT TextureCube : public Texture
        {
        protected:
        public:
        ...
        class SHAPES_EXPORT TextureDepth : public Texture
        {
        public:
        ...
        class SHAPES_EXPORT TextureDepthArray : public Texture
        {
        public:
