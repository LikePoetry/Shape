...
static const uint32_t RENDERER_POINT_SIZE        = sizeof(Shapes::Graphics::PointVertexData) * 4;
...
static const uint32_t RENDERER_LINE_SIZE        = sizeof(Shapes::Graphics::LineVertexData) * 4;
...
namespace Shapes::Graphics
{
    ...
    void SceneRenderer::BeginScene(Scene* scene)
    {
        ...
        if(renderSettings.Renderer3DEnabled)
        {
            ...
            {
                SHAPES_PROFILE_SCOPE("Get Light");
        ...
        if(renderSettings.Renderer2DEnabled)
        {
            ...
            {
                SHAPES_PROFILE_SCOPE("Sort Meshes by distance from camera");
            ...
            {
                SHAPES_PROFILE_SCOPE("Sort sprites by z value");
    ...
    {
        SHAPES_PROFILE_FUNCTION();
        SHAPES_PROFILE_GPU("Render Passes");
    ...
    void SceneRenderer::UpdateCascades(Scene* scene, Light* light)
    {
        ...
        for(uint32_t i = 0; i < m_ShadowData.m_ShadowMapNum; i++)
        {
            SHAPES_PROFILE_SCOPE("Create Cascade");
    ...
    {
        SHAPES_PROFILE_FUNCTION();
        SHAPES_PROFILE_GPU("Shadow Pass");
        ...
        for(uint32_t i = 0; i < m_ShadowData.m_ShadowMapNum; ++i)
        {
            SHAPES_PROFILE_GPU("Shadow Layer Pass");
    ...
    {
        SHAPES_PROFILE_FUNCTION();
        SHAPES_PROFILE_GPU("Depth Pre Pass");
    ...
    {
        SHAPES_PROFILE_FUNCTION();
        SHAPES_PROFILE_GPU("Forward Pass");
    ...
    {
        SHAPES_PROFILE_FUNCTION();
        SHAPES_PROFILE_GPU("SkyBox Pass");
    ...
    {
        SHAPES_PROFILE_FUNCTION();
        SHAPES_PROFILE_GPU("Depth Of Field Pass");
    ...
    {
        SHAPES_PROFILE_FUNCTION();
        SHAPES_PROFILE_GPU("Tone Mapping Pass");
    ...
    {
        SHAPES_PROFILE_FUNCTION();
        SHAPES_PROFILE_GPU("Debanding Pass");
    ...
    {
        SHAPES_PROFILE_FUNCTION();
        SHAPES_PROFILE_GPU("Filmic Grain Pass");
    ...
    {
        SHAPES_PROFILE_FUNCTION();
        SHAPES_PROFILE_GPU("Outline Pass");
    ...
    {
        SHAPES_PROFILE_FUNCTION();
        SHAPES_PROFILE_GPU("ChromaticAberation Pass");
    ...
    {
        SHAPES_PROFILE_FUNCTION();
        SHAPES_PROFILE_GPU("Render2D Pass");
    ...
    void SceneRenderer::TextPass()
    {
        ...
        for(auto entity : textGroup)
        {
            ...
            {
                SHAPES_PROFILE_SCOPE("Convert to utf32string");
...

            {
                ...
                for(int i = 0; i < utf32string.size(); i++)
                {
                    ...
                    {
                        SHAPES_PROFILE_SCOPE("Set text buffer data");
