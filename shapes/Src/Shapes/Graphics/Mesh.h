...
namespace Shapes
{
    namespace Graphics
    {
        ...
        struct SHAPES_EXPORT BasicVertex
        {
            glm::vec3 Position;
            glm::vec2 TexCoords;
        };

        struct SHAPES_EXPORT Vertex
        {
            Vertex()
...
{
    template <>
    struct hash<Shapes::Graphics::Vertex>
    {
        size_t operator()(Shapes::Graphics::Vertex const& vertex) const
        {
