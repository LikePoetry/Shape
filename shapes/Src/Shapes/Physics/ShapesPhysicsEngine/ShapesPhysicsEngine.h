...
namespace Shapes
{
    enum class SHAPES_EXPORT IntegrationType : uint32_t
    {
        EXPLICIT_EULER      = 0,
    ...
    enum class SHAPES_EXPORT BroadphaseType : uint32_t
    {
        BRUTE_FORCE    = 0,
        SORT_AND_SWEAP = 1,
        OCTREE         = 2,
    ...
    class SHAPES_EXPORT ShapesPhysicsEngine : public ISystem
    {
    public:
        ShapesPhysicsEngine();
        ~ShapesPhysicsEngine();
