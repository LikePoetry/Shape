...
namespace Shapes
{
                                                       ...
                                                       std::vector<CollisionPair>& collisionPairs)
    {
        ...
        for(uint32_t i = 0; i < objectCount; i++)
        {
            ...
            {
                SHAPES_PROFILE_SCOPE("Merge Bounding box and add Physics Object");
    ...
    void OctreeBroadphase::Divide(OctreeNode& division, const size_t iteration)
    {
        ...
        {
            SHAPES_PROFILE_SCOPE("Create Child");
            ...
            {
                SHAPES_PROFILE_SCOPE("PhysicsObject BB check");
