...
namespace Shapes
{
    ...
    struct SHAPES_EXPORT CollisionEdge
    {
    ...
    class SHAPES_EXPORT CollisionShape
    {
    public:
        CollisionShape()
            : m_Type()
        ...
        {
            SHAPES_LOG_ERROR("Loading abstract CollisionShape");
        }

        template <class Archive>
        void save(Archive& archive) const
        {
            SHAPES_LOG_ERROR("Serialising abstract CollisionShape");
        }
