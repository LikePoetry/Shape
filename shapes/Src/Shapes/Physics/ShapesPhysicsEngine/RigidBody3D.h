...
#include "Physics/ShapesPhysicsEngine/CollisionShapes/CollisionShape.h"
#include "Physics/ShapesPhysicsEngine/CollisionShapes/SphereCollisionShape.h"
#include "Physics/ShapesPhysicsEngine/CollisionShapes/CuboidCollisionShape.h"
#include "Physics/ShapesPhysicsEngine/CollisionShapes/PyramidCollisionShape.h"
#include "Physics/ShapesPhysicsEngine/CollisionShapes/HullCollisionShape.h"
#include "Physics/ShapesPhysicsEngine/CollisionShapes/CapsuleCollisionShape.h"
#include "Maths/Maths.h"
#include <cereal/types/polymorphic.hpp>
#include <cereal/cereal.hpp>

CEREAL_REGISTER_TYPE(Shapes::SphereCollisionShape);
CEREAL_REGISTER_TYPE(Shapes::CuboidCollisionShape);
CEREAL_REGISTER_TYPE(Shapes::PyramidCollisionShape);
CEREAL_REGISTER_TYPE(Shapes::HullCollisionShape);
CEREAL_REGISTER_TYPE(Shapes::CapsuleCollisionShape);

CEREAL_REGISTER_POLYMORPHIC_RELATION(Shapes::CollisionShape, Shapes::SphereCollisionShape);
CEREAL_REGISTER_POLYMORPHIC_RELATION(Shapes::CollisionShape, Shapes::CuboidCollisionShape);
CEREAL_REGISTER_POLYMORPHIC_RELATION(Shapes::CollisionShape, Shapes::PyramidCollisionShape);
CEREAL_REGISTER_POLYMORPHIC_RELATION(Shapes::CollisionShape, Shapes::HullCollisionShape);
CEREAL_REGISTER_POLYMORPHIC_RELATION(Shapes::CollisionShape, Shapes::CapsuleCollisionShape);

namespace Shapes
{
    class ShapesPhysicsEngine;
    class Manifold;
    ...
    class SHAPES_EXPORT RigidBody3D : public RigidBody
    {
        friend class ShapesPhysicsEngine;
    ...
    public:
        ...
        {
            SHAPES_ASSERT(v > 0, "Physics object mass <= 0");
            m_InvMass = 1.0f / v;
