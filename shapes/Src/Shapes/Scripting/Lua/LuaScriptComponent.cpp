...
namespace Shapes
{
    ...
    void LuaScriptComponent::LoadScript(const std::string& fileName)
    {
        ...
        {
            SHAPES_LOG_ERROR("Failed to Load Lua script {0}", fileName);
            m_Env = nullptr;
            return;
        }
        ...
        if(!loadFileResult.valid())
        {
            ...
            SHAPES_LOG_ERROR("Failed to Execute Lua script {0}", physicalPath);
            SHAPES_LOG_ERROR("Error : {0}", err.what());
    ...
    void LuaScriptComponent::OnInit()
    {
        if(m_OnInitFunc)
        {
            ...
            if(!result.valid())
            {
                ...
                SHAPES_LOG_ERROR("Failed to Execute Script Lua Init function");
                SHAPES_LOG_ERROR("Error : {0}", err.what());
            }
        }
    }
    ...
    void LuaScriptComponent::OnUpdate(float dt)
    {
        if(m_UpdateFunc)
        {
            ...
            {
                sol::error err = result;
                SHAPES_LOG_ERROR("Failed to Execute Script Lua OnUpdate");
                SHAPES_LOG_ERROR("Error : {0}", err.what());
            }
        }
    }
    ...
    void LuaScriptComponent::OnCollision2DBegin()
    {
        if(m_Phys2DBeginFunc)
        {
            ...
            {
                sol::error err = result;
                SHAPES_LOG_ERROR("Failed to Execute Script Lua OnCollision2DBegin");
                SHAPES_LOG_ERROR("Error : {0}", err.what());
            }
        }
    }
    ...
    void LuaScriptComponent::OnCollision2DEnd()
    {
        if(m_Phys2DEndFunc)
        {
            ...
            {
                sol::error err = result;
                SHAPES_LOG_ERROR("Failed to Execute Script Lua OnCollision2DEnd");
                SHAPES_LOG_ERROR("Error : {0}", err.what());
            }
        }
    }
    ...
    void LuaScriptComponent::OnCollision3DBegin()
    {
        if(m_Phys3DBeginFunc)
        {
            ...
            {
                sol::error err = result;
                SHAPES_LOG_ERROR("Failed to Execute Script Lua OnCollision3DBegin");
                SHAPES_LOG_ERROR("Error : {0}", err.what());
            }
        }
    }
    ...
    void LuaScriptComponent::OnCollision3DEnd()
    {
        if(m_Phys3DEndFunc)
        {
            ...
            {
                sol::error err = result;
                SHAPES_LOG_ERROR("Failed to Execute Script Lua OnCollision3DEnd");
                SHAPES_LOG_ERROR("Error : {0}", err.what());
            }
        }
    }
