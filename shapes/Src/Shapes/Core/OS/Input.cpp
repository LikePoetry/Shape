...
namespace Shapes
{
    ...
    {
        SetKeyPressed(Shapes::InputCode::Key(e.GetKeyCode()), e.GetRepeatCount() < 1);
        SetKeyHeld(Shapes::InputCode::Key(e.GetKeyCode()), true);
        return false;
    }

    bool Input::OnKeyReleased(KeyReleasedEvent& e)
    {
        SetKeyPressed(Shapes::InputCode::Key(e.GetKeyCode()), false);
        SetKeyHeld(Shapes::InputCode::Key(e.GetKeyCode()), false);
        return false;
    }

    bool Input::OnMousePressed(MouseButtonPressedEvent& e)
    {
        SetMouseClicked(Shapes::InputCode::MouseKey(e.GetMouseButton()), true);
        SetMouseHeld(Shapes::InputCode::MouseKey(e.GetMouseButton()), true);
        return false;
    }

    bool Input::OnMouseReleased(MouseButtonReleasedEvent& e)
    {
        SetMouseClicked(Shapes::InputCode::MouseKey(e.GetMouseButton()), false);
        SetMouseHeld(Shapes::InputCode::MouseKey(e.GetMouseButton()), false);
        return false;
    }
