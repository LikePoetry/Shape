...
namespace Shapes
{
    ...
    class SHAPES_EXPORT Input : public ThreadSafeSingleton<Input>
    {
    ...
    public:
        ...
        bool GetKeyPressed(Shapes::InputCode::Key key) const { return m_KeyPressed[int(key)]; }
        bool GetKeyHeld(Shapes::InputCode::Key key) const { return m_KeyHeld[int(key)]; }
        bool GetMouseClicked(Shapes::InputCode::MouseKey key) const { return m_MouseClicked[int(key)]; }
        bool GetMouseHeld(Shapes::InputCode::MouseKey key) const { return m_MouseHeld[int(key)]; }

        void SetKeyPressed(Shapes::InputCode::Key key, bool a) { m_KeyPressed[int(key)] = a; }
        void SetKeyHeld(Shapes::InputCode::Key key, bool a) { m_KeyHeld[int(key)] = a; }
        void SetMouseClicked(Shapes::InputCode::MouseKey key, bool a) { m_MouseClicked[int(key)] = a; }
        void SetMouseHeld(Shapes::InputCode::MouseKey key, bool a) { m_MouseHeld[int(key)] = a; }
