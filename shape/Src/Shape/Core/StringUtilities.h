...
namespace Shape
{
	namespace StringUtilities
	{
		...
		std::vector<std::string> SHAPE_EXPORT SplitString(const std::string& string, const std::string& delimiters);
		std::vector<std::string> SHAPE_EXPORT SplitString(const std::string& string, const char delimiter);
		std::vector<std::string> SHAPE_EXPORT Tokenize(const std::string& string);
