...
namespace Shape
{
    namespace Graphics
    {
        uint32_t VKUtilities::FindMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties)
        {
            ...
            SHAPE_LOG_ERROR("Failed to find suitable memory type!");
            return 0;
        }
            ...
            VkDeviceMemory& bufferMemory, VmaAllocator allocator, VmaAllocation allocation)
        {
            ...
            {
                SHAPE_LOG_ERROR("Failed to allocate buffer memory!");
            }
        ...
        VkPipelineStageFlags AccessFlagsToPipelineStage(VkAccessFlags accessFlags, const VkPipelineStageFlags stageFlags)
        {
            ...
            while (accessFlags != 0)
            {
                ...
                SHAPE_ASSERT(AccessFlag != 0 && (AccessFlag & (AccessFlag - 1)) == 0, "Error");
                ...
                default:
                    SHAPE_LOG_ERROR("Unknown access flag");
                    break;
                }
            }
            return stages;
        ...
        VkPipelineStageFlags LayoutToAccessMask(const VkImageLayout layout, const bool isDestination)
        {
            ...
            case VK_IMAGE_LAYOUT_UNDEFINED:
                if (isDestination)
                {
                    SHAPE_LOG_ERROR("The new layout used in a transition must not be VK_IMAGE_LAYOUT_UNDEFINED.");
                }
                break;
            ...
            case VK_IMAGE_LAYOUT_PREINITIALIZED:
                ...
                {
                    SHAPE_LOG_ERROR("The new layout used in a transition must not be VK_IMAGE_LAYOUT_PREINITIALIZED.");
                }
                break;
            ...
            default:
                SHAPE_LOG_ERROR("Unexpected image layout");
                break;
            }
            ...
            VkFormatFeatureFlags features)
        {
            ...
            SHAPE_LOG_ERROR("Failed to find supported format!");
...
#undef STR
        ...
        VkSamplerAddressMode VKUtilities::TextureWrapToVK(const TextureWrap wrap)
        {
            ...
            default:
                SHAPE_LOG_CRITICAL("[Texture] Unsupported wrap type!");
                return VK_SAMPLER_ADDRESS_MODE_CLAMP_TO_EDGE;
            }
        }
        ...
        RHIFormat VKUtilities::VKToFormat(VkFormat format)
        {
            ...
            default:
                SHAPE_LOG_CRITICAL("[Texture] Unsupported texture type!");
                return RHIFormat::R8G8B8A8_Unorm;
            }
        }
        ...
        VkPolygonMode VKUtilities::PolygonModeToVk(Shape::Graphics::PolygonMode mode)
        {
            switch (mode)
            {
            ...
            case Graphics::PolygonMode::POINT:
                ...
                break;
            default:
                SHAPE_LOG_CRITICAL("Unknown Polygon Mode");
                return VK_POLYGON_MODE_FILL;
                break;
            }
        }

        VkPrimitiveTopology VKUtilities::DrawTypeToVk(Shape::Graphics::DrawType type)
        {
            switch (type)
            {
            ...
            case DrawType::POINT:
                ...
                break;
            default:
                SHAPE_LOG_CRITICAL("Unknown Draw Type");
                return VK_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST;
                break;
            }
        }
