...
namespace Shape
{
    namespace Graphics
    {
        ...
        {
            SHAPE_PROFILE_FUNCTION();
            SHAPE_ASSERT(m_Primary, "BeginRecording() called from a secondary command buffer!");
        ...
        {
            SHAPE_PROFILE_FUNCTION();
            SHAPE_ASSERT(!m_Primary, "BeginRecordingSecondary() called from a primary command buffer!");
            m_State = CommandBufferState::Recording;
        ...
        {
            SHAPE_PROFILE_FUNCTION();
            SHAPE_ASSERT(m_State == CommandBufferState::Recording, "CommandBuffer ended before started recording");
        ...
        {
            SHAPE_PROFILE_FUNCTION();
            SHAPE_ASSERT(m_Primary, "Used Execute on secondary command buffer!");
            SHAPE_ASSERT(m_State == CommandBufferState::Ended, "CommandBuffer executed before ended recording");
            ...
            {
                SHAPE_PROFILE_SCOPE("vkQueueSubmit");
        ...
        {
            SHAPE_PROFILE_FUNCTION();
            SHAPE_ASSERT(!m_Primary, "Used ExecuteSecondary on primary command buffer!");
            m_State = CommandBufferState::Submitted;
