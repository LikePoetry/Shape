...
#include "Physics/ShapePhysicsEngine/CollisionShapes/CollisionShape.h"
#include "Physics/ShapePhysicsEngine/CollisionShapes/SphereCollisionShape.h"
#include "Physics/ShapePhysicsEngine/CollisionShapes/CuboidCollisionShape.h"
#include "Physics/ShapePhysicsEngine/CollisionShapes/PyramidCollisionShape.h"
#include "Physics/ShapePhysicsEngine/CollisionShapes/HullCollisionShape.h"
#include "Physics/ShapePhysicsEngine/CollisionShapes/CapsuleCollisionShape.h"
#include "Maths/Maths.h"
#include <cereal/types/polymorphic.hpp>
#include <cereal/cereal.hpp>

CEREAL_REGISTER_TYPE(Shape::SphereCollisionShape);
CEREAL_REGISTER_TYPE(Shape::CuboidCollisionShape);
CEREAL_REGISTER_TYPE(Shape::PyramidCollisionShape);
CEREAL_REGISTER_TYPE(Shape::HullCollisionShape);
CEREAL_REGISTER_TYPE(Shape::CapsuleCollisionShape);

CEREAL_REGISTER_POLYMORPHIC_RELATION(Shape::CollisionShape, Shape::SphereCollisionShape);
CEREAL_REGISTER_POLYMORPHIC_RELATION(Shape::CollisionShape, Shape::CuboidCollisionShape);
CEREAL_REGISTER_POLYMORPHIC_RELATION(Shape::CollisionShape, Shape::PyramidCollisionShape);
CEREAL_REGISTER_POLYMORPHIC_RELATION(Shape::CollisionShape, Shape::HullCollisionShape);
CEREAL_REGISTER_POLYMORPHIC_RELATION(Shape::CollisionShape, Shape::CapsuleCollisionShape);

namespace Shape
{
    class ShapePhysicsEngine;
    class Manifold;
    ...
    class SHAPE_EXPORT RigidBody3D : public RigidBody
    {
        friend class ShapePhysicsEngine;
    ...
    public:
        ...
        {
            SHAPE_ASSERT(v > 0, "Physics object mass <= 0");
            m_InvMass = 1.0f / v;
