...
namespace Shape
{
    ...
    struct SHAPE_EXPORT CollisionEdge
    {
    ...
    class SHAPE_EXPORT CollisionShape
    {
    public:
        CollisionShape()
            : m_Type()
        ...
        {
            SHAPE_LOG_ERROR("Loading abstract CollisionShape");
        }

        template <class Archive>
        void save(Archive& archive) const
        {
            SHAPE_LOG_ERROR("Serialising abstract CollisionShape");
        }
