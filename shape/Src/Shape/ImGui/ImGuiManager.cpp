...
#if defined(SHAPE_PLATFORM_MACOS) || defined(SHAPE_PLATFORM_WINDOWS) || defined(SHAPE_PLATFORM_LINUX)
#define USING_GLFW
#endif
...
namespace Shape
{
    ...
    void ImGuiManager::OnInit()
    {
        ...
        SHAPE_LOG_INFO("ImGui Version : {0}", IMGUI_VERSION);
#ifdef IMGUI_USER_CONFIG
        SHAPE_LOG_INFO("ImConfig File : {0}", std::string(IMGUI_USER_CONFIG));
#endif
    ...
    int ShapeMouseButtonToImGui(Shape::InputCode::MouseKey key)
    {
        switch(key)
        {
        case Shape::InputCode::MouseKey::ButtonLeft:
            return 0;
        case Shape::InputCode::MouseKey::ButtonRight:
            return 1;
        case Shape::InputCode::MouseKey::ButtonMiddle:
            return 2;
        default:
            return 4;
        }
    ...
    {
        ImGuiIO& io                                               = ImGui::GetIO();
        io.MouseDown[ShapeMouseButtonToImGui(e.GetMouseButton())] = true;
    ...
    {
        ImGuiIO& io                                               = ImGui::GetIO();
        io.MouseDown[ShapeMouseButtonToImGui(e.GetMouseButton())] = false;
    ...
    bool ImGuiManager::OnKeyPressedEvent(KeyPressedEvent& e)
    {
        ...
        io.KeyCtrl  = io.KeysDown[(int)Shape::InputCode::Key::LeftControl] || io.KeysDown[(int)Shape::InputCode::Key::RightControl];
        io.KeyShift = io.KeysDown[(int)Shape::InputCode::Key::LeftShift] || io.KeysDown[(int)Shape::InputCode::Key::RightShift];
        io.KeyAlt   = io.KeysDown[(int)Shape::InputCode::Key::LeftAlt] || io.KeysDown[(int)Shape::InputCode::Key::RightAlt];

#ifdef _WIN32
        io.KeySuper = false;
#else
        io.KeySuper = io.KeysDown[(int)Shape::InputCode::Key::LeftSuper] || io.KeysDown[(int)Shape::InputCode::Key::RightSuper];
#endif
    ...
    void ImGuiManager::SetImGuiKeyCodes()
    {
        ...
        io.KeyMap[ImGuiKey_Tab]        = (int)Shape::InputCode::Key::Tab;
        io.KeyMap[ImGuiKey_LeftArrow]  = (int)Shape::InputCode::Key::Left;
        io.KeyMap[ImGuiKey_RightArrow] = (int)Shape::InputCode::Key::Right;
        io.KeyMap[ImGuiKey_UpArrow]    = (int)Shape::InputCode::Key::Up;
        io.KeyMap[ImGuiKey_DownArrow]  = (int)Shape::InputCode::Key::Down;
        io.KeyMap[ImGuiKey_PageUp]     = (int)Shape::InputCode::Key::PageUp;
        io.KeyMap[ImGuiKey_PageDown]   = (int)Shape::InputCode::Key::PageDown;
        io.KeyMap[ImGuiKey_Home]       = (int)Shape::InputCode::Key::Home;
        io.KeyMap[ImGuiKey_End]        = (int)Shape::InputCode::Key::End;
        io.KeyMap[ImGuiKey_Insert]     = (int)Shape::InputCode::Key::Insert;
        io.KeyMap[ImGuiKey_Delete]     = (int)Shape::InputCode::Key::Delete;
        io.KeyMap[ImGuiKey_Backspace]  = (int)Shape::InputCode::Key::Backspace;
        io.KeyMap[ImGuiKey_Space]      = (int)Shape::InputCode::Key::Space;
        io.KeyMap[ImGuiKey_Enter]      = (int)Shape::InputCode::Key::Enter;
        io.KeyMap[ImGuiKey_Escape]     = (int)Shape::InputCode::Key::Escape;
        io.KeyMap[ImGuiKey_A]          = (int)Shape::InputCode::Key::A;
        io.KeyMap[ImGuiKey_C]          = (int)Shape::InputCode::Key::C;
        io.KeyMap[ImGuiKey_V]          = (int)Shape::InputCode::Key::V;
        io.KeyMap[ImGuiKey_X]          = (int)Shape::InputCode::Key::X;
        io.KeyMap[ImGuiKey_Y]          = (int)Shape::InputCode::Key::Y;
        io.KeyMap[ImGuiKey_Z]          = (int)Shape::InputCode::Key::Z;
