...
namespace Shape
{
    namespace Graphics
    {
        ...
        struct SHAPE_EXPORT BasicVertex
        {
            glm::vec3 Position;
            glm::vec2 TexCoords;
        };

        struct SHAPE_EXPORT Vertex
        {
            Vertex()
...
{
    template <>
    struct hash<Shape::Graphics::Vertex>
    {
        size_t operator()(Shape::Graphics::Vertex const& vertex) const
        {
