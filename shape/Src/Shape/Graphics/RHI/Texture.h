...
namespace Shape
{
	namespace Graphics
	{
		class SHAPE_EXPORT Texture :public Asset
		{
		public:
			virtual ~Texture()
			{
		...
		class SHAPE_EXPORT Texture2D : public Texture
		{
		public:
		...
		class SHAPE_EXPORT TextureCube : public Texture
		{
		protected:
		public:
		...
		class SHAPE_EXPORT TextureDepth : public Texture
		{
		public:
		...
		class SHAPE_EXPORT TextureDepthArray : public Texture
		{
		public:
