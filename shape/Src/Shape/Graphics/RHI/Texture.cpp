...
namespace Shape
{
	namespace Graphics
	{
		...
		RHIFormat Texture::BitsToFormat(uint32_t bits)
		{
			...
			default:
				SHAPE_ASSERT(false, "[Texture] Unsupported image bit-depth! ({0})", bits);
				return RHIFormat::R8G8B8A8_Unorm;
			}
		}
		...
		{
			SHAPE_ASSERT(CreateFunc, "No Texture2D Create Function");
		...
		{
			SHAPE_ASSERT(CreateFromSourceFunc, "No Texture2D Create Function");
		...
		{
			SHAPE_ASSERT(CreateFromFileFunc, "No Texture2D Create Function");
		...
		{
			SHAPE_ASSERT(CreateFunc, "No TextureCube Create Function");
		...
		{
			SHAPE_ASSERT(CreateFromFileFunc, "No TextureCube Create Function");
		...
		{
			SHAPE_ASSERT(CreateFromFilesFunc, "No TextureCube Create Function");
		...
		{
			SHAPE_ASSERT(CreateFromVCrossFunc, "No TextureCube Create Function");
		...
		{
			SHAPE_ASSERT(CreateFunc, "No TextureDepth Create Function");
		...
		{
			SHAPE_ASSERT(CreateFunc, "No TextureDepthArray Create Function");
