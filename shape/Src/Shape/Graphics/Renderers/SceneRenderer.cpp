...
static const uint32_t RENDERER_POINT_SIZE        = sizeof(Shape::Graphics::PointVertexData) * 4;
...
static const uint32_t RENDERER_LINE_SIZE        = sizeof(Shape::Graphics::LineVertexData) * 4;
...
namespace Shape::Graphics
{
    ...
    void SceneRenderer::BeginScene(Scene* scene)
    {
        ...
        if(renderSettings.Renderer2DEnabled)
        {
            ...
            {
                SHAPE_PROFILE_SCOPE("Sort Meshes by distance from camera");
            ...
            {
                SHAPE_PROFILE_SCOPE("Sort sprites by z value");
    ...
    {
        SHAPE_PROFILE_FUNCTION();
        SHAPE_PROFILE_GPU("Render Passes");
    ...
    void SceneRenderer::UpdateCascades(Scene* scene, Light* light)
    {
        ...
        for(uint32_t i = 0; i < m_ShadowData.m_ShadowMapNum; i++)
        {
            SHAPE_PROFILE_SCOPE("Create Cascade");
    ...
    void SceneRenderer::ShadowPass()
    {
        ...
        for(uint32_t i = 0; i < m_ShadowData.m_ShadowMapNum; ++i)
        {
            SHAPE_PROFILE_GPU("Shadow Layer Pass");
    ...
    {
        SHAPE_PROFILE_FUNCTION();
        SHAPE_PROFILE_GPU("Depth Pre Pass");
    ...
    {
        SHAPE_PROFILE_FUNCTION();
        SHAPE_PROFILE_GPU("Forward Pass");
    ...
    {
        SHAPE_PROFILE_FUNCTION();
        SHAPE_PROFILE_GPU("Depth Of Field Pass");
    ...
    {
        SHAPE_PROFILE_FUNCTION();
        SHAPE_PROFILE_GPU("Tone Mapping Pass");
    ...
    {
        SHAPE_PROFILE_FUNCTION();
        SHAPE_PROFILE_GPU("Debanding Pass");
    ...
    {
        SHAPE_PROFILE_FUNCTION();
        SHAPE_PROFILE_GPU("Filmic Grain Pass");
    ...
    {
        SHAPE_PROFILE_FUNCTION();
        SHAPE_PROFILE_GPU("Outline Pass");
    ...
    {
        SHAPE_PROFILE_FUNCTION();
        SHAPE_PROFILE_GPU("ChromaticAberation Pass");
    ...
    {
        SHAPE_PROFILE_FUNCTION();
        SHAPE_PROFILE_GPU("Render2D Pass");
    ...
    void SceneRenderer::TextPass()
    {
        ...
        for(auto entity : textGroup)
        {
            ...
            {
                SHAPE_PROFILE_SCOPE("Convert to utf32string");
...

            {
                ...
                for(int i = 0; i < utf32string.size(); i++)
                {
                    ...
                    {
                        SHAPE_PROFILE_SCOPE("Set text buffer data");
