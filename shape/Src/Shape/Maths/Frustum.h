...
namespace Shape
{
    namespace Maths
    {
        ...
        public:
            ...
            void DefineOrtho(float scale, float aspectRatio, float gnear, float gfar, const glm::mat4& viewMatrix);
            void Define(float fov, float aspectRatio, float gnear, float gfar, const glm::mat4& viewMatrix);
