...
#include "Physics/ShapePhysicsEngine/Constraints/SpringConstraint.h"
#include "Physics/ShapePhysicsEngine/Constraints/WeldConstraint.h"
#include "Physics/ShapePhysicsEngine/Constraints/DistanceConstraint.h"
#include "Physics/ShapePhysicsEngine/Constraints/AxisConstraint.h"
...
namespace Shape
{
    ...
    class SHAPE_EXPORT RigidBody3DComponent
    {
    public:
