...
namespace Shape
{
    ...
    void SceneManager::SwitchScene(const std::string& name)
    {
        ...
        {
            SHAPE_LOG_ERROR("[SceneManager] - Unknown Scene Alias : {0}", name.c_str());
        }
    }
    ...
    void SceneManager::ApplySceneSwitch()
    {
        ...
        {
            SHAPE_LOG_ERROR("[SceneManager] - Invalid Scene Index : {0}", m_QueuedSceneIndex);
            m_QueuedSceneIndex = 0;
        }
        ...
        SHAPE_LOG_INFO("[SceneManager] - Scene switched to : {0}", m_CurrentScene->GetSceneName().c_str());
    ...
    void SceneManager::EnqueueScene(Scene* scene)
    {
        ...
        SHAPE_LOG_INFO("[SceneManager] - Enqueued scene : {0}", scene->GetSceneName().c_str());
    }
